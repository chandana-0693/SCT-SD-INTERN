...
It includes 
Task-1: Temperature converter using python              
Task-2: Number guess game using python            
Task-3:To do list application using python        
Task-4:Sticky notes using python        
